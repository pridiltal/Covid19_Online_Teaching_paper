...
\hypertarget{keyword-selection}{%
\subsection{Keyword selection}\label{keyword-selection}}
...
Google Trends does not report the absolute search volume of a single term but does report the relative search volumes for up to five multiple terms \autocite{vaughan2014web}.
