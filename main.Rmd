...
```{r psychosocialSupportAnalysis, fig.height= 3, fig.cap="Goolge search trend of the term 'Psychosocial support' under 'All categories' and 'Education' category"}
```

Good psychosocial support is also vital to improve both students' and  teachers' mental health and well-being during a pandemic. This is evident in Figure \ref{fig: psychosocialSupportAnalysis} from the two suddent spikes in the search trend series of  the term 'Psychosocial support' during the academic breaks in August 2020 and in August 20201 under 'Education' category. This highlight the urgent need of attention and solutions towards these aspects. This type of an analysis based on secondary data is very vital as these types of aspects can be easily overlooked due to the lack of connection and communication between students and educators during school closures. 
...
https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0248029
